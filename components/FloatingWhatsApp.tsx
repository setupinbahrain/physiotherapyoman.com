...
export default function FloatingWhatsApp({ lang }: { lang: 'en' | 'ar' }) {
  const isAr = lang === 'ar';
  return (
    <div style={{ position: 'fixed', bottom: '30px', right: '30px', zIndex: 1000, display: 'flex', flexDirection: 'column', gap: '15px' }}>
      ...
      >
        <div className="whatsapp-icon-wrapper glass-box">
        ...
        <span className="whatsapp-text">{isAr ? "دعم الطوارئ (٢)" : "Emergency (2)"}</span>
      </a>

      {/* Hotline 1 */}
      <a 
        href="https://wa.me/96872517821" 
        target="_blank" 
        rel="noopener noreferrer"
        className="floating-whatsapp pulse-animation"
        style={{ position: 'relative', bottom: '0', right: '0' }}
      ...
      >
        ...
        <span className="whatsapp-text">{isAr ? "العيادة الرئيسية (١)" : "Main Desk (1)"}</span>
      </a>
